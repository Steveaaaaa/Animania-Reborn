...
Place `animania-neoforge-1.21.1-0.1.5.jar` in your instance's `mods` folder and remove older
...
Version 0.1.5 is still being checked in game. A successful build does not establish
