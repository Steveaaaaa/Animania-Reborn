...
Current release: **1.0.1**. This branch targets **Minecraft 1.21.1**, **NeoForge 21.1.200+** and **Java 21**.
...
Build with Java 21: `./gradlew build -x test --no-daemon` (`gradlew.bat` on Windows). Output goes to `build/libs`.
