...
final class AmphibianHabitatGoal extends Goal {
    ...
    private void beginRest() {
        ...
        ModAttachments.setData(animal, ModAttachments.FARM_ACTIVITY, animal.kind() == AnimaniaAmphibian.Kind.FROG
    ...
    @Override public void stop() {
        animal.getNavigation().stop(); ModAttachments.setData(animal, ModAttachments.FARM_ACTIVITY, 0);
