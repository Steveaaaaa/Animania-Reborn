...
public final class ModEntities {
    ...
    public static final RegistryObject<EntityType<com.animania.farm.chicken.BlueEggProjectile>> BLUE_EGG = ENTITY_TYPES.register("blue_egg",
    ...
    public static final RegistryObject<EntityType<com.animania.modern.ModernFox>> MODERN_FOX = ENTITY_TYPES.register("modern_fox",
    ...
    public static final RegistryObject<EntityType<com.animania.modern.MountainGoat>> MOUNTAIN_GOAT = ENTITY_TYPES.register("mountain_goat",
    ...
    public static final Map<String, RegistryObject<EntityType<com.animania.modern.ModernFox>>> MODERN_FOX_BREEDS = new LinkedHashMap<>();
    public static final Map<String, RegistryObject<EntityType<com.animania.modern.MountainGoat>>> MOUNTAIN_GOAT_BREEDS = new LinkedHashMap<>();
