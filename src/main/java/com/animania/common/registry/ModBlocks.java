...
public final class ModBlocks {
    ...
    private static final Map<String, RegistryObject<com.animania.common.world.block.PatternedBedBlock>> PATTERNED_BEDS = new java.util.LinkedHashMap<>();
        ...
        for (String type : new String[]{"flecked", "inky", "tan", "rocky"}) {
            ...
            PATTERNED_BEDS.put(type, BLOCKS.register("bed_" + type,
                    () -> new com.animania.common.world.block.PatternedBedBlock(color,
                            BlockBehaviour.Properties.copy(net.minecraft.world.level.block.Blocks.WHITE_BED))));
        }
    }

    public static Map<String, RegistryObject<com.animania.common.world.block.PatternedBedBlock>> patternedBeds() {
