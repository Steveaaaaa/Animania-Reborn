...
public final class ModItems {
    ...
    public static final DeferredItem<Item> BLUE_EGG = ITEMS.register("blue_egg",
    ...
    public static final Map<String, DeferredItem<net.minecraft.world.item.MobBucketItem>> AXOLOTL_BUCKETS = new LinkedHashMap<>();
    static {
        ModEntities.AXOLOTL_BREEDS.forEach((breed, type) -> {
            ...
            AXOLOTL_BUCKETS.put(breed, ITEMS.register(breed + "_axolotl_bucket",
                    () -> new net.minecraft.world.item.MobBucketItem(type.get(), net.minecraft.world.level.material.Fluids.WATER, net.minecraft.sounds.SoundEvents.BUCKET_EMPTY_AXOLOTL,
