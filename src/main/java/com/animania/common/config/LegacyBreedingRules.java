...
public final class LegacyBreedingRules {
    ...
    public static boolean isReady(Animal animal) {
        return com.animania.common.entity.HusbandryMood.breedingAllowed(animal) && animal.getAge() == 0 && animal.getData(ModAttachments.RECOVERY) == 0 && !AnimalInformation.isSterilized(animal)
