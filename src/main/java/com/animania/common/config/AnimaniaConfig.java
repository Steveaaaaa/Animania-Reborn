...
public final class AnimaniaConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue REPLACE_MODERN_FOXES;
    public static final ForgeConfigSpec.BooleanValue REPLACE_MOUNTAIN_GOATS;
    ...
    public static final ForgeConfigSpec.ConfigValue<java.util.List<? extends String>> HUNGER_BLACKLIST;
    public static final ForgeConfigSpec.ConfigValue<java.util.List<? extends String>> THIRST_BLACKLIST;
    public static final ForgeConfigSpec.BooleanValue REPLACE_VANILLA_ANIMALS;
    public static final ForgeConfigSpec.BooleanValue REPLACE_VANILLA_CATS;

    public static final ForgeConfigSpec.BooleanValue ANIMAL_MOOD, MOOD_PENALTIES;
    public static final ForgeConfigSpec.IntValue MOOD_GRACE_TICKS;
