...
public final class FarmHerdGoal extends Goal {
    ...
    private boolean free() {
        return !animal.isBaby() && animal.isAlive() && !animal.isOnFire() && !animal.isInWaterOrBubble()
                ...
                && !ModAttachments.getData(animal, ModAttachments.SLEEPING) && ModAttachments.getData(animal, ModAttachments.EATING_TICKS) == 0
                && ModAttachments.getData(animal, ModAttachments.FARM_ACTIVITY) == 0
