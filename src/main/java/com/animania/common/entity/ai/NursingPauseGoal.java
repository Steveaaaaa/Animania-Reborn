...
public final class NursingPauseGoal extends Goal {
    ...
    @Override public boolean canUse() {
        return ModAttachments.getData(child, ModAttachments.FAMILY_POSE) == FamilyAnimationState.SUCKLE
                && child.isBaby() && !ModAttachments.getData(child, ModAttachments.SLEEPING) && child.hurtTime == 0
