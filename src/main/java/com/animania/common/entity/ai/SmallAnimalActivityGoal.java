...
public final class SmallAnimalActivityGoal extends Goal {
    ...
    private boolean free() {
        if (!animal.isAlive() || animal.isPassenger() || animal.isVehicle() || animal.isLeashed()
                ...
                || animal.getTarget() != null || animal.getData(ModAttachments.SLEEPING)
                || animal.getData(ModAttachments.EATING_TICKS) > 0) return false;
    ...
    private void begin() {
        ...
        animal.setData(ModAttachments.FARM_ACTIVITY, activity);
    ...
    @Override public void stop() {
        animal.setData(ModAttachments.FARM_ACTIVITY, 0); animal.getNavigation().stop();
