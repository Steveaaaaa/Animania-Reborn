...
public final class HorseAlertGoal extends Goal {
    ...
    private boolean free() {
        return !horse.isBaby() && !horse.isVehicle() && !horse.isPassenger() && !horse.isLeashed()
                ...
                && !horse.getData(ModAttachments.SLEEPING) && !horse.isInWaterOrBubble()
    ...
    @Override public void start() {
        ...
        horse.setData(ModAttachments.FARM_ACTIVITY, FarmActivityGoal.ALERT);
        horse.setData(ModAttachments.FARM_ACTIVITY_START, (int) horse.level().getGameTime());
    }
    ...
    @Override public void stop() {
        horse.getNavigation().stop(); horse.setData(ModAttachments.FARM_ACTIVITY, 0);
