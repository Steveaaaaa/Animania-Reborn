...
public final class AnimaniaJadePlugin implements IWailaPlugin {
    ...
    public void registerClient(IWailaClientRegistration registration) {
        registration.addTooltipCollectedCallback((box, accessor) -> {
            if (accessor instanceof EntityAccessor entityAccessor
                ...
                box.getTooltip().remove(snownee.jade.api.JadeIds.MC_NEXT_ENTITY_DROP);
        });
    ...
    private enum AnimalProvider implements IEntityComponentProvider, IServerDataProvider<EntityAccessor> {
        ...
        public void appendServerData(CompoundTag data, EntityAccessor accessor) {
            ...
            data.putInt("FarmActivity", animal.getData(ModAttachments.FARM_ACTIVITY));
            ...
            data.putInt("Recovery", animal.getData(ModAttachments.RECOVERY));
