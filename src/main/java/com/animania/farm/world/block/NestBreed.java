...
public enum NestBreed implements StringRepresentable {
    ...
    AMBER("amber", ChickenBreed.AMBER, null),
    BRONZED("bronzed", ChickenBreed.BRONZED, null),
    GOLD_CRESTED("gold_crested", ChickenBreed.GOLD_CRESTED, null),
    MIDNIGHT("midnight", ChickenBreed.MIDNIGHT, null),
    COLD("cold", ChickenBreed.COLD, null),
    WARM("warm", ChickenBreed.WARM, null),
