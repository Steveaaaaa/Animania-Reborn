...
public final class AnimaniaHorse extends Horse {
    ...
    protected void positionRider(net.minecraft.world.entity.Entity passenger,
        ...
        double defaultSeatHeight = getDefaultPassengerAttachmentPoint(this, passenger, getAttachments()).y;
        double heightCorrection = saddleSurfaceHeight() - defaultSeatHeight;
        super.positionRider(passenger, (rider, x, y, z) ->
                callback.accept(rider, x + offset.x, y + heightCorrection, z + offset.z));
    }
