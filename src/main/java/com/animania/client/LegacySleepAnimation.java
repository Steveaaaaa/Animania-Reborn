...
public final class LegacySleepAnimation {
    ...
    static void transform(net.minecraft.world.entity.animal.Animal animal,
        ...
        boolean resting = animal.getData(ModAttachments.FARM_ACTIVITY) == com.animania.common.entity.ai.FarmActivityGoal.RUMINATE
                || animal.getData(ModAttachments.FARM_ACTIVITY) == com.animania.common.entity.ai.FarmActivityGoal.PET_REST;
        if (!animal.getData(ModAttachments.SLEEPING) && !resting) return;
